...
const GooeyNav = ({
  ...
  // если снаружи поменялся initialActiveIndex (по URL) — обновляем локальный стейт
  useEffect(() => {
  ...
  const handleClickInternal = (liEl, index, item) => {
    // если кликаем по уже активному — просто даём знать наверх
  ...
  const handleClick = (e, index, item) => {
    ...
    handleClickInternal(liEl, index, item);
  };
